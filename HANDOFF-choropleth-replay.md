...
测试账号 claude-test@example.com / [removed; use WEBGIS_TEST_PASSWORD](测试库)。
...
- 测试栈仍在 19000(后端)/5175(前端)运行;测试库账号 claude-test@example.com / [removed; use WEBGIS_TEST_PASSWORD];不需要时直接结束进程即可。
