...
class LayerRecord:
    ...
    # Bumped only when ``data`` changes, so clients can skip re-parsing
    # unchanged GeoJSON on visibility/opacity updates.
    data_rev: int = 0
...
class LessonRecord:
    ...
    def find_stage(self, stage_id: str) -> Optional[Dict[str, Any]]:
