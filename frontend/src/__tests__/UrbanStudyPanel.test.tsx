...
it("keeps unconfigured map visits distinct from real 3D loading and preserves source provenance",()=>{
  ...
  expect(screen.getByRole("status")).toHaveTextContent("选择区域");
